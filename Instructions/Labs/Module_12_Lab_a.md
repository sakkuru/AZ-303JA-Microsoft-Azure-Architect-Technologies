...
1. Azure portal で、App Service Web アプリのデプロイスロットを表示しているブレードに戻ります。

1. Azure portal の App Service Web アプリのデプロイスロットを表示しているブレードで、プロダクション スロットを表示している行の値を **トラフィック ％** 列を 50 にします。これにより、本番スロットを表す行の **トラフィック ％** の値が自動的に 50 に設定されます。
