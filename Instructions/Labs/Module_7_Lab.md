...
1. 「**az30311a-labRG - Access Control (IAM)**」 ブレードで、「**役割**」 をクリックします。

1. 「**役割**」 ブレードで、「**所有者**」 を選択します。
...
1. 「**仮想マシン**」 ブレードで、RBAC を使用して委託できる管理アクションの一覧を確認します。これには、**仮想マシンの割り当て解除**と **仮想マシンの開始**アクションが含まれます。
